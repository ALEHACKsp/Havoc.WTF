...
void DrawStrokeCircle(int x, int y, int radius, RGBA* color, RGBA* normalcol, int segments)
{
	ImGui::GetOverlayDrawList()->AddCircle(ImVec2(x, y), radius, ImGui::ColorConvertFloat4ToU32(ImVec4(normalcol->R / 255.0, normalcol->G / 255.0, normalcol->B / 255.0, normalcol->A / 255.0)), segments);
